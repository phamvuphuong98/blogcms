    ...
    <div class="main-header">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="/"><figure class="mb-0 banner-logo"><img src="{{ asset('assets/images/lgo.png') }}" alt="" class="img-fluid"></figure></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="last_list">
                        <figure class="nav-phoneimage mb-0"><img class="img-fluid" src="{{ asset('assets/images/nav-phoneimage.png') }}" alt=""></figure>
                        <div class="content">
                            <p class="text-size-18 text-white">Call Anytime:</p>
                            <a class="text-decoration-none last_list_atag" href="tel:4693709526">(469)3709526</a>
                        </div>
                    </div>
                </div>
            </nav>
