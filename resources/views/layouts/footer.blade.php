            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-6 col-12">
                    <div class="first-column">
                        ...
                        <p class="text-size-18 footer-text">Boost your sales on Amazon with our exceptional Listing Creation Services, optimized to maximize visibility and attract customers to your products.</p>
                        <div class="lower">
                            <div class="lower-content">
                                ...
                                <div class="content">
                                    ...
                                    <a class="text-size-18 mb-0 text text-decoration-none" href="tel:4693709526">(469)3709526</a>
                                </div>
                            </div>
                            <div class="lower-content">
                                <figure class="icon">
                                ...
                                <div class="content">
                                    ...
                                    <a href="mailto:support@jasonprivatelabel.com" class="text-size-18 mb-0 text-decoration-none">support@jasonprivatelabel.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
