...
<head>
    ...
    <title>Jason Private Label</title>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="assets/images/lgo_ino.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/lgo_ino.png">
...
<body>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-right">
                        <div class="social-icons position-relative" data-aos="fade-up">
                            <ul class="list-unstyled position-absolute">
                                <li><a target="_blank" href="https://www.facebook.com/profile.php?id=100088175378109" class="text-decoration-none"><i class="fa-brands fa-facebook-f social-networks"></i></a></li>
                        ...
                        <div class="banner_content">
                            ...
                            <h2 class="text-white" style="font-size: 45px">Optimize, Convert, Succeed</h2>
                            <p>Optimizing Your Listing into a Pro-Quality, Skyrocketing Conversion Rates and Amplifying Profits to Unprecedented Levels.</p>
                            <p>Supercharge Amazon Conversions Right Now with JPL Team!</p>
    ...
    <script>
        ...
        chatbox.setAttribute("page_id", "100088175378109");
