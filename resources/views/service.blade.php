                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="banner_content" data-aos="fade-up">
                        ...
                        <div class="box">
                            ...
                            <span class="mb-0 box_span">Service</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="servicepage-section service-section">
        ...
        <div>
            ...
            <div class="service_contentbox">
                <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;" style="margin: 0 15px">
                    <div class="col-xl-12">
                        <div class="row">
                            <div class="col-xl-3 col-lg-6">
                                <div class="item">
                                    <div class="service-box box-mb" style="width: 100%; height: 380px">
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="item">
                                    <div class="service-box" style="width: 100%; height: 380px">
                                        <div style="display: flex; justify-content: space-between; align-items: center;">
