...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold">
            ...
            <a href="{{ route('admin.portfolio.index') }}"
                class="{{ request()->routeIs('*.portfolio.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100' }} flex items-center text-white  py-4 pl-6 nav-item">
                <i class="fas fa-briefcase mr-3"></i>
                Portfolios
            </a>
            <a href="{{ route('admin.review.index') }}"
                class="{{ request()->routeIs('*.review.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100' }} flex items-center text-white  py-4 pl-6 nav-item">
                <i class="fas  fa-sticky-note mr-3"></i>
                Reviews
            </a>
    ...
    @if (request()->routeIs('*.portfolio.create') || request()->routeIs('*.portfolio.edit'))
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js"
            integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ=="
            crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.css" rel="stylesheet">
        ...
        <script>
            $('#title').change(function(e) {
                $.get('{{ route('admin.portfolio.getslug') }}', {
                        'title': $(this).val()
                    },
                    function(data) {
                        $('#slug').val(data.slug);
